    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="section-title">
                <i class="bi bi-journal-bookmark-fill me-2"></i> Gestión de Préstamos
            </h2>
        </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="${pageContext.request.contextPath}/prestamos"
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="clienteId" class="form-select form-elegant" required>
                        ...
                        <div class="mt-2">
                            <a href="${pageContext.request.contextPath}/clientes"
                               class="text-decoration-none small">
                                ¿Nuevo cliente? Registrarlo aquí
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="libroId" class="form-select form-elegant" required>
