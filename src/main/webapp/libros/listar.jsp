...
<body>
	...
	<div class="biblioteca-container">
		...
		<c:if test="${param.error == 'id_requerido'}">
			<div class="alert alert-danger">❌ Error: No se proporcionó el
				ID del libro</div>
		</c:if>

		<c:if test="${param.error == 'id_invalido'}">
			<div class="alert alert-danger">❌ Error: El ID del libro es
				inválido</div>
		</c:if>

		<c:if test="${param.error == 'eliminar'}">
			<div class="alert alert-danger">❌ Error al eliminar el libro.
		...
		<div style="margin-bottom: 15px;">
			<a class="btn-agregar" href="${pageContext.request.contextPath}/libros/registrar"> ➕
			...
			<tbody>
				<c:forEach var="libro" items="${libros}">
					<tr>
						...
						<td><a
							href="${pageContext.request.contextPath}/actualizar/libros?id=${libro.id}">
								✏️ Editar </a>
