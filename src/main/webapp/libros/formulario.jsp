...
<body>
	...
	<div class="page-wrapper">
		<div class="form-container">
			...
			<p class="subtitle">Completa los datos del libro para agregarlo
				al catálogo</p>
			...
			<form action="${pageContext.request.contextPath}/libros/registrar"
				...
				<div class="form-group">
					<label for="isbn">ISBN <span class="required">*</span></label> <input
						type="text" id="isbn" name="isbn"
						placeholder="Ej: 978-3-16-148410-0" required maxlength="50">
				...
				<div class="form-group">
					...
					<input type="number" id="anio" name="anio" placeholder="Ej: 2024"
						required min="1000" max="2100" value="2024">
				</div>

				<div class="form-group">
					<label for="autor">Autor <span class="required">*</span></label> <select
					...
					<div class="help-text">
						¿No encuentras el autor? <a
							href="${pageContext.request.contextPath}/autores/registrar"
							target="_blank"> Regístralo aquí </a>
					</div>
				</div>

				<div class="form-group">
					<label for="stock">Stock Inicial</label> <input type="number"
						id="stock" name="stock" placeholder="Ej: 10" min="0" max="9999"
						value="0">
					<div class="help-text">Cantidad de ejemplares disponibles
						(por defecto: 0)</div>
				</div>
			...
			<div class="back-link">
				<a href="${pageContext.request.contextPath}/libros">← Volver al
					listado de libros</a>
			</div>
